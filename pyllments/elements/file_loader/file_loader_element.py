...
class FileLoaderElement(Element):
    ...
    @Component.view
    def create_file_input_view(self, input_css: list = [], sizing_mode: str = 'stretch_width', width: int = None) -> pn.widgets.FileInput:
    ...
    @Component.view
    def create_file_container_view(self, container_css: list = [], sizing_mode: str = "stretch_both", height: int = None, width: int = None) -> pn.Column:
    ...
    @Component.view
    def create_file_send_view(self, button_css: list = [], sizing_mode: str = 'stretch_width', width: int = None, height: int = None) -> pn.widgets.Button:
    ...
    @Component.view
    def create_file_loader_view(self, sizing_mode: str = 'stretch_both', width: int = None, height: int = None) -> pn.Column:
