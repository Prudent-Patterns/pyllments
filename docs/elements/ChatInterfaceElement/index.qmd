...
|------------------------------|-------------------------|----------------------------------------------------------------------------------------------------|
| `user_message_input`         | MessagePayload          | Displays a user message in the chat feed (no downstream emit).                                     |
| `assistant_message_input`    | MessagePayload          | Displays an assistant message in the chat feed (no downstream emit).                                |
| `user_message_emit_input`    | MessagePayload          | Displays and then emits user messages via `user_message_output` and `message_output`.              |
| `assistant_message_emit_input` | MessagePayload        | Displays and then emits assistant messages via `assistant_message_output` and `message_output`.     |
