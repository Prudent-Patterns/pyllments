...
|---------------|-----------------|-------------------------------------------|
| `message_input` | MessagePayload | Sends outgoing messages from the flow to Discord users via DM. |
...
| Port Name       | Payload Type    | Behavior                                      |
|-----------------|-----------------|-----------------------------------------------|
| `message_output`| MessagePayload  | Emits messages received from Discord users as `MessagePayload`. |
